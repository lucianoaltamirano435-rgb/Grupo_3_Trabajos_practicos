...
def calcular_nan(base, nombre_base):
    ...
    for año in años:
        ...
        resultado[f"{nombre_base}_{año}"] = subset.isnull().mean() * 100
...
print(tabla_pond_pct_2024.applymap(lambda x: f"{x:.2f}"))

#%% 3.3. Gráfico de barras del año 2024:
fig, ax = plt.subplots(figsize = (8, 5))

tabla_pond_pct_2024.T.plot(
    kind="bar",
    stacked=True,
    ax=ax,
    color=["#2196F3", "#F44336"],
...
ax.legend(title="Condición laboral", loc="upper center", bbox_to_anchor=(0.5, -0.12), ncol=2)

plt.subplots_adjust(bottom=0.2)
plt.savefig("grafico_informalidad_genero_2024.png", dpi=300, bbox_inches="tight")
plt.show()
...
print(tabla_pond_pct_2025.applymap(lambda x: f"{x:.2f}"))

#%% 3.3. Gráfico de barras del año 2025:
fig, ax = plt.subplots(figsize=(8, 5))

tabla_pond_pct_2025.T.plot(
    kind="bar",
    stacked=True,
    ax=ax,
    color=["#2196F3", "#F44336"],
...
plt.subplots_adjust(bottom=0.2)
plt.savefig("grafico_informalidad_genero_2025.png", dpi=300, bbox_inches="tight")
plt.show()
